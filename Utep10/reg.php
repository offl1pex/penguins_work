...
<h1>Форма регистрации</h1>
	<form action="reg-db.php" method="post">
		<input type="text" name="email" class="form-control" id="login" placeholder="Логин"><br>
		<input type="password" name="pass" class="form-control" id="pass" placeholder="Пароль"><br>
		<input type="text" name="username" class="form-control" id="username" placeholder="Имя пользователя"><br>
